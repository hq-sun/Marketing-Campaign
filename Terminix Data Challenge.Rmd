...
```{r}
# Add Target column
X_train <- cbind(m.train_complete, sale = y_train$sale)
write.csv(x=X_train, file="./data/clean/X_train.csv")

Log1 = glm(sale~., data = X_train, family = binomial, weights = cases)
summary(Log1)
